...
<TreeSelector client:load trees={["Spike", "Teeth"]}>
<TreeBranch description="The deadly tail spikes of the manticore manifest in your weapon. Your weapon has 24 tail spikes, spent tail spikes regenerate after a short rest. You may spend a tail spike to make the following attack">

<InfusionTier tier="minor" name="Shooting Spikes" bonus="">
...
<WeaponVariant label="Shotel & Gladus">
...
<WeaponVariant label="Spatha & Kopesh">
...
<InfusionTier tier="major" name="Peircing Spikes" bonus="+1">
...
<InfusionTier tier="apex" name="Pinning Spikes" bonus="+2">
...
<TreeBranch description="The manticore has three rows of sharp teeth, your blade is similarly serrated. Hit points lost to this weapon's damage can be regained only through a Short or Long Rest, rather than by regeneration, magic, or any other means.">

<InfusionTier tier="minor" name="Gnashing Teeth" bonus="">
...
<InfusionTier tier="major" name="Rending Teeth" bonus="+1">
...
<WeaponVariant label="Sapatha & Kopesh">
...
<InfusionTier tier="apex" name="Almuftaras' Devouring Maw" bonus="+2">
