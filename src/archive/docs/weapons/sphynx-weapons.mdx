...
<TreeSelector client:load trees={["Fate", "Free-Will"]}>
<TreeBranch description="Mortals move in this world governed by the same laws that make rocks fall, flowers bloom or the sun set. You are no more able to change your fate than the sun is able to stay hidden. These laws govern your existance, and you are now one of the few able to see the path that lies before you all.">

<InfusionTier tier="minor" name="Action" bonus="">

<WeaponVariant label="Wand">
...
<InfusionTier tier="major" name="Reaction" bonus="+1">
...
<InfusionTier tier="apex" name="Ahnuket's Golden Path" bonus="+2">
...
<InfusionTier tier="major" name="Choice" bonus="+1">
...
<InfusionTier tier="apex" name="Senmanat's Offer" bonus="+2">
