...
<TreeSelector client:load trees={["Fire", "Ice"]}>
<TreeBranch description="This weapon is imbued with the hot desert, echoing Simurgh, the Fire's Fury. Any additional damage dice gained from being a Roc weapon are fire damage instead of their normal type. This sword sheds bright light within 20 feet of it and dim light for an additional 20 feet.">

<InfusionTier tier="minor" name="Scorching Winds" bonus="">

A Minor roc weapon gains an additional ability based it's weapon type.

<WeaponVariant label="Labrys & Shotel">
...
<WeaponVariant label="Tabarzin & Spatha">
...
<InfusionTier tier="major" name="Fiery Blaze" bonus="+1">
...
<InfusionTier tier="apex" name="Simurgh's Fury" bonus="+2">
...
<TreeBranch description="This weapon is imbued with the chill wind of the cold mountain peaks echoing Skymoriax, the Icy Glare. Any additional weapon damage dice gained from being a roc weapon do cold damage instead of their normal type. Additionally the wielder can use an action to snuff any open flames within 20 feet of the wielder">

<InfusionTier tier="minor" name="Chilling Winds" bonus="">
...
<InfusionTier tier="major" name="Icy Gale" bonus="+1">
...
<InfusionTier tier="apex" name="Skymoriax's Glare" bonus="+2">
