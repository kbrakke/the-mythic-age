...
<TreeSelector client:load trees={["Stupor", "Enchantment"]}>
<TreeBranch description="Your weapon can unleash a powerful psychic blast.">
...
<InfusionTier tier="minor" name="Disruption" bonus="">

A Minor siren weapon gains an additional ability based it's weapon type.

<WeaponVariant label="Gladus & Warhammer">
...
<WeaponVariant label="Kopesh & Thrown Hammer">
...
<TreeBranch description="Your weapon emits a subconscious tone, suffusing the air around it.">
...
<InfusionTier tier="minor" name="Charm" bonus="">
