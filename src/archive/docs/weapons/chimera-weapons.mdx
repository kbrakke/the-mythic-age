...
<TreeSelector client:load trees={["Amalgam", "Harmony"]}>
<TreeBranch description="This weapon morphs, taking on aspects of all manner of weaponry.">

<InfusionTier tier="minor" name="Amalgam" bonus="">
...
<InfusionTier tier="major" name="Mutation" bonus="+1">
...
<InfusionTier tier="apex" name="Chimeric Vigor" bonus="+2">
...
<TreeBranch description="This weapon has become a perfect union of the chimeric creatures.">

<InfusionTier tier="minor" name="Harmony" bonus="">
...
<InfusionTier tier="major" name="Syncronity" bonus="+1">
...
<InfusionTier tier="apex" name="Trinity" bonus="+2">
