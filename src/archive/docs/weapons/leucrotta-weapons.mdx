...
<TreeSelector client:load trees={["Disease", "Mimicry"]}>
<TreeBranch description="Your weapon carries a virulent disease that worsens over time.">
...
<InfusionTier tier="minor" name="Infection" bonus="">

<WeaponVariant label="Doru & Warhammer">
...
<WeaponVariant label="Javelin & Thrown Hammer">
...
<InfusionTier tier="major" name="Plague" bonus="+1">

Your weapons gains a +1 to attack and damage rolls.

<WeaponVariant label="Warhammer, Maul">
...
<InfusionTier tier="apex" name="Wither, Blister, Burn and Peel" bonus="+2">
...
<TreeBranch description="You gain mimicry dice that enhance your deception and charisma.">
...
<InfusionTier tier="minor" name="Fascimillie" bonus="">
...
<WeaponVariant label="Javelin & Throwing Hammer">
...
<InfusionTier tier="major" name="Uncanny Valley" bonus="">
...
<InfusionTier tier="apex" name="Cruel Mimicry" bonus="+2">
